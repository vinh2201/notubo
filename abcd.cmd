@echo off
TITLE Windows 11 22H2 slim down and integrate updates
CLS
...
for /f "delims=" %%i in ('dir /b "%~dp0*.iso" 2^>nul') do (
 echo %%i 2>nul | findstr /r /c:"^Windows11_x[86][46]_[a-zA-Z][a-zA-Z]-[a-zA-Z][a-zA-Z]*\.iso" >nul 2>&1 || set "ISOName=%%i"
)
...
if "%ISOName%"=="" (
 if "%InstallWIMfile%"=="" (
  ...
  ECHO.
  ECHO Please copy Windows 11 22H2 ISO DVD to the same location as Slimdown10
  ECHO ========================================================================
  ECHO.
  PAUSE >NUL
  goto end
...
if not "%checkErrors%"=="0" (
 ...
 ECHO.
 ECHO ==========================================================================
 ECHO This script supports only original Windows 11 images for x86 or x64 CPUs!
 ECHO.
...
ECHO.
ECHO ================================================================
ECHO Downloading missing Windows 11 22H2 Updates...
ECHO ================================================================
ECHO.
...
if "%EnableStore%"=="0" set "IncludeUWPapps=%IncludeUWPapps%,Microsoft.Windows.SecHealthUI,Microsoft.DesktopAppInstaller,Microsoft.UI.Xaml,Microsoft.WinJS,Microsoft.NET.Native.Framework,Microsoft.NET.Native.Runtime,Microsoft.Media.PlayReadyClient,Microsoft.ScreenSketch,microsoft.windowscommunicationsapps,Microsoft.Windows.Photos,Microsoft.MicrosoftStickyNotes,Microsoft.ZuneVideo,Microsoft.ZuneMusic,Microsoft.BingWeather,Microsoft.WindowsCalculator,Microsoft.WindowsNotepad,Microsoft.Paint,Microsoft.WindowsTerminal,Microsoft.WindowsAlarms,Microsoft.BingNews,Microsoft.WindowsMaps,Microsoft.RawImageExtension,Microsoft.6365217CE6EB4,Microsoft.SecHealthUI"
rem "Microsoft.Services.Store.Engagement"
if not "%EnableStore%"=="0" set "IncludeUWPapps=%IncludeUWPapps%,Microsoft.Windows.SecHealthUI,Microsoft.UI.Xaml,Microsoft.WindowsStore,Microsoft.DesktopAppInstaller"
rem "Microsoft.Services.Store.Engagement"
...
Reg add "HKLM\TK_SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate" /v "ProductVersion" /t REG_SZ /d "Windows 11" /f >nul
...
"%~dp0tools\%HostArchitecture%\oscdimg.exe" -bootdata:2#p0,e,b"%~dp0DVD\boot\etfsboot.com"#pEF,e,b"%~dp0DVD\efi\microsoft\boot\Efisys.bin" -h -m -u2 -udfver102 "%~dp0DVD" "%~dp0Windows11_%ImageArchitecture%_%ImageLanguage%.iso" -lWin11
